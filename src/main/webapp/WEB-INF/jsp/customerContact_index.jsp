...
<title>Insert title here</title>
	<script type="text/javascript">
 	$(function(){
 		...
 		/*展示数据的datagrid表格*/
 		$("#datagrid").edatagrid({
 			url:'${ctx}/customerContact/selectById.action?id=${param.id}',//只查询已分配咨询师的
 			saveUrl:'${ctx}/customerContact/add.action?customerId=${param.id}',
 			updateUrl:'${ctx}/customerContact/update.action?customerId=${param.id}',
 			...
 			columns:[[ 
                 {field:"cb",checkbox:true,align:"center"},
 			     ...
 			     {field:'time',title:'交往时间',width:30,align:'center',editor:{type:'datebox',options:{required:true}}},    
 			     {field:'address',title:'交往地点',width:30,align:'center',editor:{type:'validatebox',options:{required:true}}},    
 			     {field:'overview',title:'概要',width:30,align:'center',editor:{type:'validatebox',options:{required:true}}},  
 			]],
 			onSuccess : function() {
