...
<title>Insert title here</title>
	<script type="text/javascript">
 	$(function(){
 		...
 		/*展示数据的datagrid表格*/
 		$("#datagrid").edatagrid({
 			url:'${ctx}/customerLinkMan/selectById.action?id=${param.id}',//只查询已分配咨询师的
 			...
 			columns:[[ 
                 {field:"cb",checkbox:true,align:"center"},
 			     ...
 			     {field:'linkName',title:'姓名',width:30,align:'center',editor:{type:'validatebox',options:{required:true}}},    
 			     {field:'gender',title:'性别',width:30,align:'center',editor:{type:'validatebox',options:{required:true}}},    
 			     {field:'position',title:'职位',width:30,align:'center',editor:{type:'validatebox',options:{required:true}}},  
 			     {field:'officePhone',title:'办公电话',width:30,align:'center',editor:{type:'validatebox',options:{required:true}}},
 			     {field:'phone',title:'手机',width:30,align:'center',editor:{type:'validatebox',options:{required:true}}} 
 			]],
 			onSuccess : function() {
